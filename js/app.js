...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const echoForm = document.querySelector('#echo-submission form');
    const echoContentInput = document.getElementById('echo-content');
    const contextTagsInput = document.getElementById('context-tags');
    ...
    function addExploreButtonListeners() {
        document.querySelectorAll('.resonance-path-card button').forEach(button => {
            button.addEventListener('click', () => {
                var _a, _b, _c;
                const pathId = ((_c = (_b = (_a = button.previousElementSibling) === null || _a === void 0 ? void 0 : _a.previousElementSibling) === null || _b === void 0 ? void 0 : _b.textContent) === null || _c === void 0 ? void 0 : _c.replace('Path ID: ', '')) || 'unknown_path';
